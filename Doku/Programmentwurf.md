...
Während meiner ehrenamtlichen Tätigkeit als "Finanzer" wurde mir bewusst, dass die bisherige Praxis der Haushaltsplanung mit Hilfe von Excel-Tabellen ineffizient und zeitaufwändig ist. Die Verwaltung und Analyse komplexer finanzieller Informationen gestaltete sich in einer unübersichtlichen Tabellenkalkulation als mühsam und fehleranfällig.
...
Bei der Entwicklung des Prototyps wurden auch Design Patterns wie das Observer Pattern und das Factory Pattern integriert, um die Flexibilität, Erweiterbarkeit und Wartbarkeit der Anwendung zu erhöhen. Die Prinzipien des Domain Driven Design (DDD) und der Clean Architecture wurden berücksichtigt, um eine gut strukturierte Softwarearchitektur zu gewährleisten, die an die spezifische Domäne der Studierendenvertretung angepasst ist.
